  ...
  return (
    <section className="py-[120px] bg-surface-container/40 px-6 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <p className="font-mono-tactical text-xs tracking-[0.3em] text-primary mb-2">[ SYSTEM_LOG: SECURITY_LAB ]</p>
          <h2 className="text-4xl font-headline font-bold uppercase tracking-tight">Cyber Lab Entries</h2>
        </div>
          ...
          {securityLabs.map((lab, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 text-[10px] font-mono-tactical">
                <div>
                  <span className="text-on-surface-variant block uppercase">Tool</span>
                  <span className="text-secondary">{lab.tool}</span>
                </div>
                <div>
                  <span className="text-on-surface-variant block uppercase">Action</span>
                  <span className="text-secondary">{lab.tool}_CAPTURE</span>
                </div>
                <div>
                  <span className="text-on-surface-variant block uppercase">Result</span>
