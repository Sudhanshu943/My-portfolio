    ...
    <section className="py-[120px] bg-surface-container/85 px-6 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FadeIn className="bg-surface-container p-8 space-y-6 border-l-4 border-primary">
            <h3 className="font-mono-tactical text-xl font-bold text-primary uppercase">
              Current Modules
            </h3>
          ...
          >
            <h3 className="font-mono-tactical text-xl font-bold text-secondary uppercase">
              Next Sequence
            </h3>
            <ul className="space-y-4">
